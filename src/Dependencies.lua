...
-- The extra balls that spawns in
require 'src/ExtraBall'
require 'src/ExtraBall2'

-- A key that allows the locked bricks to be destroyed
require 'src/Key'
...
-- the entities in our game that randomly drop when a player hits a brick
